...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        int id = item.getItemId(); // Get the ID once
    ...
    public boolean onContextItemSelected(@NonNull MenuItem item) {
        ...
        int index = info.position; // Use the actual clicked position
        User c = listUser.get(index);
        ...
        if (itemId == R.id.mnuEdit) {
            ...
            bundle.putString("Phone", c.getPhoneNum());
            intent.putExtras(bundle);
            startActivityForResult(intent, 200);
        }
        else if (itemId == R.id.mnuDel) {
            // ... your existing AlertDialog code here ...
        }
        else if (itemId == R.id.mnuCall) {
